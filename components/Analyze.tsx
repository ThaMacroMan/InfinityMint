...
const Analyze: React.FC = () => {
 ...
 //LIST OF PROJECTS HERE
  const projects = ['What collection do you want to analyze?','pavia','hungrycowsbymuesliswap', 'adapeepos','cardanobits', 'tappy', 'oldmoney', 'toolheads', 'theapesociety', 'blockowlshydracollection', 'blockowls-plutuscollection', 'blockowls-c1collection'];
  ...
  useEffect(() => {
    if(hasMinRequiredTokens && isProjectValid) {
  ...
  return (
    <div className="bg-gray-900 text-gray-200 p-4 min-h-400">
      <h2 className="text-xl font-bold mb-4">Catsky AI CatBot: Discover Undvervalued NFTS</h2>
      <div className="mb-4 text-black">
        <select
          onChange={(e) => setSelectedProject(e.target.value)}
          className="select-button w-full p-1 border appearance-none"
        >
