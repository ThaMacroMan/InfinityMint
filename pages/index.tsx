...
const Home: NextPage = () => {
  ...
  const updateOptions = () => {
    ...
    if (selectedModel === "dall-e-2") {
      ...
      const sizeOptions = [{ value: "1024x1024", label: "Square" }];
      sizeOptions.forEach((optionData) => {
        const option = document.createElement("option");
        option.value = optionData.value;
        option.textContent = optionData.label;
    ...
    <>
      ...
      <div className="wrapper">
        ...
        <div className="form">
          <div className="pixelfont" style={{ zIndex: 1000 }}>
            <div className="flex tag">
              ...
              <div>
                <h1 className="infobutton" onClick={toggleInfo}>
                  More Info
                </h1>
          ...
          <div className="tag">Hold 100M $CATSKY for HD Model</div>
          ...
          <form>
            ...
            <button
              ...
              onClick={() => {
                getRandomPrompt();
                setPrompt("");
              }} // Clear prompt area when "Generate Prompt" is clickex
            >
            ...
            <div className="tag2">
              <label htmlFor="model" className="tag">
                Style
              </label>
            ...
            <div>
              ...
              {showInfo && (
                <div className="info-popup">
                  <p>
                    <span id="gradient-text"> Models:</span> Dalle 2 and 3 are
                    the current OpenAI Image Genearation Models. Dalle3 is
                    significantly better, but slower
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="tag2">
              <label htmlFor="size" className="tag">
                Size
              </label>
              <div className="dropdown-container">
                <select
            ...
            <div>
              ...
              {showInfo && (
                <div className="info-popup">
                  <p>
                    <span id="gradient-text"> Small = </span> 256x256
                  </p>
                  <p>
                    <span id="gradient-text"> Medium =</span> 512x512
                  </p>
                  <p>
                    <span id="gradient-text"> Large = </span> 1024x1024
                  </p>
                  <p>
                    <span id="gradient-text"> Square = </span> 1024x1024
                  </p>
                  <p>
                    <span id="gradient-text"> Landscape = </span> 1792x1024
                  </p>
                  <p>
                    <span id="gradient-text"> Portrait = </span> 1024x1792
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="tag2">
              <label htmlFor="quality" className="tag">
                Quality
              </label>
              <div className="dropdown-container">
                <select
            ...
            <div>
              ...
              {showInfo && (
                <div className="info-popup">
                  <p>
                    <span id="gradient-text"> Qualtiy:</span> Dalle 3 has 2
                    quality options to try
                  </p>
                </div>
              )}
            </div>
            <button
              ...
              className={`button animated-gradient ${
                isLoading || catskyBalance < 100000000 ? "disabled-button" : ""
              }`}
              disabled={isLoading}
            >
            ...
            <div>
              ...
              {showInfo && (
                <div className="info-popup">
                  <p>
                    <span id="gradient-texts"></span> Hold $CATSKY when minting!
                  </p>
                  <br></br>
                  <p>
                    <span id="gradient-text"> 0.5 B = ₳ 1 ADA</span> an 11%
                    Discount
                  </p>
                  <p>
                    <span id="gradient-text"> 1.0 B = ₳ 2 ADA</span> an 22%
                    Discount!
                  </p>
                  <p>
                    <span id="gradient-text"> 3.0 B = ₳ 3 ADA</span> an 34%
                    Discount!!
                  </p>
                  <p>
                    <span id="gradient-text"> 5.0 B = ₳ 4 ADA</span> an 46%
                    Discount!!!
                  </p>
                </div>
              )}
        ...
        <div className="creation-container">
          <label className="pixelfont2 " id="gradient-text">
            {promptSummary}
          </label>
          {isLoading && (
